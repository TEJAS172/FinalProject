...
class Cancellation extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          title: Text('CANCELLATION REMARK', style: TextStyle(color: Colors.white)),
...
class _PTextFieldState extends State<PTextField> {
  ...
  Future<void> _handleSubmit() async {
    ...
    try {
      await _firestore.collection('Cancellation Remark').add({
      ...
      showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            title: Text('Submitted Cancellation Remarks'),
