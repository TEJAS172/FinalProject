...
class _MyFormState extends State<MyForm> {
  ...
  onPressed: () async {
    ...
    List<Map<String, dynamic>> newServiceInfoList = [];
    ...
    for (int i = 0; i < _titleControllers.length; i++) {
      ...
      if (i >= _titleControllers.length - _textFieldCount) {
        ...
        newServiceInfoList.add(serviceInfoMap);
      }
    }

    // Upload the data of new text fields to the Firestore database
    for (Map<String, dynamic> serviceInfoMap in newServiceInfoList) {
      String id = randomAlphaNumeric(10);
      await DatabaseMethods().addServiceCharge(serviceInfoMap, id);
    }

    // Display a toast indicating that the service charges of new text fields have been added successfully
    Fluttertoast.showToast(
      msg: "Service Charges of new fields Added Successfully",
